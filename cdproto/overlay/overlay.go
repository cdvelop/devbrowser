...
func (p *GetHighlightObjectForTestParams) Do(ctx context.Context) (highlight json.RawMessage, err error) {
	// execute
...
func (p *GetGridHighlightObjectsForTestParams) Do(ctx context.Context) (highlights json.RawMessage, err error) {
	// execute
...
func (p *GetSourceOrderHighlightObjectForTestParams) Do(ctx context.Context) (highlight json.RawMessage, err error) {
	// execute
