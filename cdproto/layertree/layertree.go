...
type SnapshotCommandLogReturns struct {
	CommandLog []json.RawMessage `json:"commandLog,omitempty"` // The array of canvas function calls.
}
...
func (p *SnapshotCommandLogParams) Do(ctx context.Context) (commandLog []json.RawMessage, err error) {
	// execute
