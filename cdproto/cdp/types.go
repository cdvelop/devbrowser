...
func Execute(ctx context.Context, method string, params any, res any) error {
...
func (t *PseudoType) UnmarshalJSON(buf []byte) error {
	...
	default:
		return fmt.Errorf("unknown PseudoType value: %v", v)
	}
	return nil
}
...
func (t *ShadowRootType) UnmarshalJSON(buf []byte) error {
	...
	default:
		return fmt.Errorf("unknown ShadowRootType value: %v", v)
	}
	return nil
}
...
func (t *CompatibilityMode) UnmarshalJSON(buf []byte) error {
	...
	default:
		return fmt.Errorf("unknown CompatibilityMode value: %v", v)
	}
	return nil
}
...
func (t *NodeType) UnmarshalJSON(buf []byte) error {
	...
	default:
		return fmt.Errorf("unknown NodeType value: %v", v)
	}
	return nil
}
